  ...
  return (
    <section className="bg-gradient-to-b from-purple-100 via-violet-500 to-cyan-300">
      <div className="min-h-screen flex flex-col justify-center p-10 mx-auto sm:py-12 lg:flex-row lg:justify-between shadow-xl">
        <div className="hidden lg:flex lg:items-center lg:justify-center w-[65%]">
          <img
        ...
        <div className="flex flex-col item-center mt-12 lg:justify-center">
          ...
          <div className="flex space-y-4 lg:flex-row lg:space-y-0 lg:space-x-4 lg:justify-start">
            <Link
              to={"/produk"}
